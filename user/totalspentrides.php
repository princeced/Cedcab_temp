...
?>
    ...
    <div class="modal" tabindex="-1" role="dialog" id="totalspentmodalshow">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h3 class="modal-title">TOTAL RIDE DETAILS</h3>
